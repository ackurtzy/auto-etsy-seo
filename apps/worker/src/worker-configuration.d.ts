/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc apps/worker/src/worker-configuration.d.ts` (hash: 4c4c7347e4351c7d0ca784bb300c1e1e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ETSY_BASE_URL" | "ETSY_EGRESS_ENABLED" | "TITLE_WRITES_ENABLED" | "EXECUTOR_VERSION" | "PUBLIC_APP_ORIGIN">> {}
}
