/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc apps/worker/src/worker-configuration.d.ts` (hash: 0713da67d2e41bca269e38c06b4f4bc7)
// Runtime types generated with workerd@1.20260918.1 2026-09-20 nodejs_compat
interface __BaseEnv_Env {
	RECOVERY_BUCKET: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	ENVIRONMENT: "local";
	ETSY_BASE_URL: "https://openapi.etsy.com/v3";
	ETSY_READ_EGRESS_ENABLED: "false";
	ETSY_EGRESS_ENABLED: "false";
	TITLE_WRITES_ENABLED: "false";
	EXECUTOR_VERSION: "title-v1";
	PUBLIC_APP_ORIGIN: "http://localhost:8787";
	SHOP_COORDINATOR: DurableObjectNamespace<import("./index").ShopCoordinator>;
	OPERATION_WORKFLOW: Workflow<Parameters<import("./index").OperationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "ShopCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ETSY_BASE_URL" | "ETSY_READ_EGRESS_ENABLED" | "ETSY_EGRESS_ENABLED" | "TITLE_WRITES_ENABLED" | "EXECUTOR_VERSION" | "PUBLIC_APP_ORIGIN">> {}
}
